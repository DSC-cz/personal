...
const Portfolio = () => {
    ...
    const [items] = useState([
        {title: "Mé portfolio", git: "https://github.com/DSC-cz/personal", desc: "Mé portfolio vytvořené v Reactu a za pomocí Bootstrapu.", type: "web", url: "https://dsc-cz.github.io/personal", thumbnail: personal_thumbnail, stack: ["React", "CSS", "Bootstrap CSS"]},
        {title: "Vue.js • Learning project", git: "https://github.com/DSC-cz/vue-js-learn", desc: "Učební projekt na Vue.js framework. Jednalo se hlavně o základní seznámení se s prostředím, nejedná se o velký projekt.", type: "web", url: "https://dsc-vue-js.vercel.app", thumbnail: vue_thumbnail, stack: ["Vue.js", "CSS", "Bootstrap CSS"]},
        ...
        {title: "Lexten.cz bot • Lexik", git: "https://github.com/DSC-cz/lexten_lexik", desc: "Discord bot • Python a discord.py + discord_slash.py. Komunikuje s webovou stránkou Lexten.cz pomocí čtení JSON formátů. Zobrazení hráčských statistik, přidělení VIP (premium) rolí. Na serveru možnost vytvoření si vlastního voice kanálu na omezený čas → kanál se nezruší dokud by tam někdo byl i po vypršení času. Odměnění hráčů přes /boostkarma pokud podpořili Discord server s Nitrem. (Karma = body ve hře, přidá do databáze k hráči +100). Seznam všech VIP hráčů → /vip. Bylo řešeno přes repl.it, kde databáze byla formou pole, které drželo veškerá data pod určitým klíčem. (základ je main.py)", type: "others", thumbnail: discord_thumbnail, stack: ["Python"]},
        {title: "Lexten.cz", git: "https://github.com/DSC-cz/lexten", desc: "Webová stránka pro herní server Counter-Strike: Global Offensive Jailbreak. Napsáno v PHP, OOP s vlastní MVC architekturou, kterou jsem zde využil poprvé, kód je tak proto kolikrát velmi zmatený, nicméně oprava již nyní při nefunkčním projektu postrádá smysl, nicméně funkční je. HTML / SASS CSS s Bootstrapem, FontAwesome ikony, jQuery. Napojeno SteamAPI auth, Discord auth API, dříve se zde objevovalo i platební brána PayPal. Web obsahuje články, vlastní diskuzní fórum, statistiky hráčů, admin tým. V administraci lze konfigurovat VIP účty na serveru → napojeno obě na databázi. Stránka je nyní již pouze ilustrací, funkčnost kvůli ztrátě dat ze serveru byla značně omezena.", type: "web", url: "http://personal-dsc.infinityfreeapp.com/lexten", thumbnail: lexten_thumbnail, stack: ["PHP", "Custom MVC", "Bootstrap", "CSS", "jQuery"]},
