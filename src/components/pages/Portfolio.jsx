...
const Portfolio = () => {
    ...
    const [items] = useState([
        ...
        {title: "SWIETELSKY • video", git: "", desc: "Propagační video v rámci 3 týdenní školní praxe, využití dronu pro tvorbu fotek a videí ze vzduchu. Střih probíhal v Adobe After Effects a Premiere.", type: "video", url: ["NCxWCko3yNI", "N58ahuxKJ_c", "O0QZ3AIu2NE"]},
