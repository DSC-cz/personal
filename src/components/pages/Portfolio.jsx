...
const Portfolio = () => {
    ...
    const [items] = useState([
        ...
        {title: "Lednicka", desc: "Aplikace v rámci zkušebního zadání. Napsáno v Laravelu - jazyk PHP, HTML, CSS, jQuery. Přidání potravin, blížíci se expirace a označení na frontendu zvýrazněním.", type: "web", url: "http://personal-dsc.infinityfreeapp.com/lednicka/main", thumbnail: lednice_thumbnail, stack: ["PHP", "Laravel", "HTML", "CSS"]},
