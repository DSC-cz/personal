...
const About = () => {
    ...
    return(
        <motion.section id="page" className="container page" intial={{opacity: 0}} animate={{opacity: 1}} exit={{opacity: 0, y: 100}}>
            ...
            <p>PHP jsem se původně začal věnovat na funkcionální / procedurální úrovni, hodně kódu bylo z počátku spíše převzato a snažil jsem se hlavně o to, aby webová stránka fungovala bez ohledu na to, jestli kódu rozumím nebo jestli je dostatečně efektivní či čitelný. Až později časem, kdy mě začala zajímat nějaká modifikace kódu, který na webové stránce byl, tak jsem začal pobírat existenci cyklů, proměnných, až jsem se dozvěděl o existenci databází, tj. <strong>MySQL a webové prostředí PHPMyAdmin</strong>.</p>
